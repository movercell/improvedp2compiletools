...
- ValveSoftware/source-sdk-2013#436 for drastic compile time speedup
- ValveSoftware/source-sdk-2013#1345 for somewhat improved static prop indirect lighting(didn't test it much, just implemeted it because i liked the results(open an issue if you need the older lighting as a compile flag))
